<%-- 
    Document   : 4toSemestreRegistrado
    Created on : 18/04/2022, 11:41:04 AM
    Author     : ximena
--%>
...
<html>
    ...
    <%
            ...
            try{
                ...
                try{
                    ...
                    System.out.println("Boleta registrada: "+bol);
    ...
    <body>
        ...
        <%
                ...
                System.out.println("Error al registrar/modificar la tabla de 4toSemestreRegistrado");
