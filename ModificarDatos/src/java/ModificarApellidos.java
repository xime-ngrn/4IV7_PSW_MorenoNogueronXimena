 ...
 * @author ximem
 */
public class ModificarApellidos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                bol=Integer.parseInt(request.getParameter("boletaact3"));
                appat=request.getParameter("appat");
                apmat=request.getParameter("apmat");
                String q="update alumnobatiz set appat='"+appat+"',apmat='"+apmat+"' where boleta="+bol;
                
                set.executeUpdate(q);
                out.println("<div id='servlet'><h1>Se han modificado los apellidos del alumno</h1>"
