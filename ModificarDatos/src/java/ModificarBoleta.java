 ...
 * @author ximem
 */
public class ModificarBoleta extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                bol=Integer.parseInt(request.getParameter("boletaact1"));
                nbol=Integer.parseInt(request.getParameter("boleta"));
                String q=
                
                set.executeUpdate(q);
                out.println("<div id='servlet'><h1>Se ha modificado la boleta del alumno</h1>"
