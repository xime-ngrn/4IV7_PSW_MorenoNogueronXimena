    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                bol=Integer.parseInt(request.getParameter("boletaact4"));
                tel=request.getParameter("telefono");
                String q="update alumnobatiz set telefono='"+tel+"' where boleta="+bol;
                
                set.executeUpdate(q);
                out.println("<div id='servlet'><h1>Se ha modificado el teléfono del alumno</h1>"
